...
class RspecHtmlFormatter < RSpec::Core::Formatters::BaseFormatter
  ...
  # REPORT_PATH = "//gv2k3ris01.babgsetc.pvt/Shared/QA Automation/android_output/rspec_html_reports/#{Time.now.strftime('result__%d_%m_%Y__%H_%M')}"
  REPORT_PATH = "C:/Users/Public/android_output/rspec_html_reports/#{Time.now.strftime('result__%d_%m_%Y__%H_%M')}"
